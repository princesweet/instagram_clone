...
if (isset($_POST['update_profile_btn'])) {
    ...
    if ($image != "") {
        $image_name = $username . ".jpg"; //username.jpg
    } else {
...
function updateUserProfile($conn, $username, $bio, $image_name, $user_id, $image)
{
    ...
    if ($stmt->execute()) {
        ...
        updateProfileImageAndUserNameInPostTable($conn, $username, $image_name, $user_id);
...
function updateProfileImageAndUserNameInPostTable($conn, $username, $image_name, $user_id)
{
